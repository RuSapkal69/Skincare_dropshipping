        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Premium skincare products for all skin types. Discover the best products for your skincare routine.
            </p>
          ...
          <div>
            ...
            <form className="flex">
              <input
                ...
                className="px-4 py-2 w-full rounded-l-md focus:outline-none focus:ring-1 focus:ring-primary"
              />
